...
<head>
<meta charset="UTF-8">
<title>Habitación 2 - Escape Room Atleti</title>
...
<style>
    body {
        ...
        padding: 0;
        height: 100vh;
        background-image: url('copa_del_rey.jpg');
...
<body>
<img src="copa.jpg" class="pista-img" onclick="alert('10')" alt="Pista">
    <div class="contenedor">

        <h1>HABITACIÓN DE LA COPA DEL REY</h1>
        ...
        <?php if ($mostrarOpciones) : ?>
            ...
            <div class="opciones">
                <a href="Habitacion_3.php">Ir a Habitación 3</a>
            </div>
        <?php endif; ?>
